    ...
    "explain": [
      {
        ...
        "body": "-ing adjectives say what the thing is LIKE (it causes the feeling).",
    ...
    "explain": [
      {
        ...
        "body": "When using multiple adjectives, there is a fixed order: OSASCOMP",
        "note": "Opinion · Size · Age · Shape · Colour · Origin · Material · Purpose"
      },
      {
        "head": "Examples",
        "body": "a lovely big old round green French silver kitchen knife",
    ...
    "explain": [
      {
        ...
        "body": "Adjectives go before a noun or after be/look/seem/feel/become.",
        "note": "a slow driver · a careful driver · she is careful · it looks good"
      },
      {
        "head": "Adverbs describe verbs/adjectives",
        "body": "Adverbs describe how an action is done. Usually formed by adjective + -ly.",
        "note": "He drives slowly. · She speaks carefully. · It's incredibly expensive. · I hardly know him."
      },
      {
        "head": "Good vs Well",
        "body": "'Good' = adjective | 'Well' = adverb (or adjective meaning healthy).",
    ...
    "explain": [
      {
        ...
        "body": "Some words have the same adjective and adverb form: fast, hard, early, late, high, low, long, near, straight.",
        "note": "a fast car (adj) · he drives fast (adv) · a hard test (adj) · she works hard (adv)"
      },
      {
        "head": "Hardly — almost not",
        "body": "'Hardly' is NOT the adverb of 'hard'. It means 'almost not/never'.",
    ...
    "explain": [
      {
        ...
        "body": "'So' goes before an adjective or adverb (no noun after).",
        "note": "The film was so long! · She speaks so quickly. · I'm so tired. · Why is he so rude?"
      },
      {
        "head": "Such + (a/an) + (adjective) + noun",
        "body": "'Such' goes before a noun (often with adjective before it).",
    ...
    "explain": [
      {
        ...
        "body": "'Too' means 'more than enough' — it's a problem.",
        "note": "It's too hot to go outside. (= so hot I can't go) · This shirt is too big for me."
      },
      {
        "head": "Enough — sufficient",
        "body": "'Enough' means 'sufficient'. Goes AFTER adjectives/adverbs but BEFORE nouns.",
      ...
      },
      {
        ...
        "body": "Often followed by 'to + infinitive' to express result.",
  ...
  "104": {
    ...
    "explain": [
      ...
      },
      {
        ...
        "body": "'Pretty' in informal English means quite/rather.",
    ...
    "explain": [
      {
        ...
        "body": "One or two syllables: add -er. Spelling: big→bigger, easy→easier, nice→nicer.",
        "note": "old→older · fast→faster · big→bigger · easy→easier · happy→happier"
      },
      {
        "head": "Long adjectives — more",
        "body": "Two or more syllables (most adjectives): use more/less.",
        "note": "more expensive · more interesting · more comfortable · more carefully"
      },
      {
        "head": "Irregular comparatives",
        "body": "Some very common adjectives don't follow the -er/more rule and have their own special comparative form.",
  ...
  "107": {
    ...
    "explain": [
      ...
      },
      {
        ...
        "body": "Other comparison expressions.",
  ...
  "108": {
    ...
    "explain": [
      ...
      },
      {
        ...
        "body": "Often followed by present perfect.",
    ...
    "explain": [
      {
        ...
        "body": "English has fixed word order. Subject comes before verb, object after.",
        "note": "She reads books. (not 'Books she reads.' in normal sentences)"
      },
      {
        "head": "Place and time — usually at end",
        "body": "Expressions of place and time usually go at the end of the sentence.",
      ...
      },
      {
        ...
        "body": "Adverbs do NOT go between the verb and its object.",
    ...
    "explain": [
      {
        ...
        "body": "Use 'even' to say something is surprising or more than expected.",
      ...
      },
      {
        ...
        "body": "'Even' can strengthen a comparative.",
